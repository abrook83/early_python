...
while True:
    ...
    c=point_numbers, cmap=plt.cm.Reds, edgecolors='none', s=1)  # feeds the data to the 'scatter' function, 's' is the dot size.
    ...
    ax.scatter(rw.x_values[-1], rw.y_values[-1], c='blue', edgecolors='none', s=100)    # make the last point in the list of values blue and larger
