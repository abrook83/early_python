...
class Alien(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        self.image = pygame.image.load('CrashProj/Projects/Alien_Invasion/ship.bmp')
    ...
    def update(self):
        ...
        self.settings.fleet_direction)         # move alien byt incrementing at each refresh at the speed in settings.py
